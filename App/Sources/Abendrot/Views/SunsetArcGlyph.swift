...
// brand-lock pass (plan §5.5, §21.4 "3-3-1 variation strategy"); this is a clear,
...
//
// The status-item glyph. `isTemplate = true` is CRITICAL (plan §6.5 / reference doc):
// without it the icon is invisible in light menu bars. macOS tints template images to
// match the bar; the "glows amber when active" treatment (§21.4) is deferred to
