...
struct AboutTab: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Grounded in peer-reviewed light research, Abendrot warms your displays around your local sunset. It’s free and open source, with no ads, in-app purchases, or paywall.")
