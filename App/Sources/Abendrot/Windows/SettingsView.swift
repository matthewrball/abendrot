...
struct CityAutocomplete: View {
    ...
    /// the selection falls back to Auto . Cleared by any explicit pick.
    ...
    // The first three are the default suggestions shown before the user types (default pick); the rest
    ...
    private var dropdown: some View {
        VStack(spacing: 4) {
            ...
            if dropdownCities.isEmpty {
                ...
                // need a long list (by preference: the search does the narrowing).
                VStack(spacing: 3) {
...
struct CozyModeControl: View {
    ...
    private func toggle() {
        if keepsSliderInPlace {
            ...
            // is the fireball thumb + "Warmest" label crossfading (by preference: keep it smooth, minimal). This
