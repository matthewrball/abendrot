...
_Last updated: 2026-06-16 · Applies to: the Abendrot macOS application and the abendrot.app website._
...
- **Hosting/region:** an EU-managed Aptabase instance, or a self-hosted instance operated by the maintainer. Analytics data is processed in the EU.
...
- **Retention:** anonymous, aggregate analytics are retained only as long as useful for product decisions and then aggregated or deleted.
...
Questions about privacy? Open an issue or discussion on [GitHub](https://github.com/matthewrball/abendrot), or report a privacy concern privately via the repository's **Security** tab.
