...
if [ ! -d "$APP" ]; then
  ...
  echo "           (Expected a built Abendrot.app. In credential-less mode this can be an" >&2
...
# Report SHA256 — the Homebrew cask + appcast both need it (see the release runbook).
